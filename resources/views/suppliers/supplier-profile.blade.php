                ...
                <div class="md:flex no-wrap md:-mx-2  ">
                    ...
                    <div class=" md:w-2/6 md:mx-2 ">
                        ...
                        <div
                            ...
                            <h1 class="text-gray-900 font-bold text-xl leading-8 my-1 text-center">ItsMeCJ</h1>
                            <div class="">
                        ...
                        <!-- Description -->
                        <div
                            class="p-8 mb-4 rounded-lg shadow-xl bg-gradient-to-br from-[#F5EFE6] via-[#E8DFCA] to-transparent">
                                    ...
                                    <div class="container">
                                        <div class=" inset-x-0 top-14 max-h-full">
                                            ...
                                            <div class="p-4">
                                                ...
                                                <p class="mb-3 font-normal text-gray-700 text-justify ">Lorem Ipsum is
                                                    simply
                                                    dummy
                                                    text of the
                        ...
                        <div class="flex justify-between border p-4 mb-8">
                            ...
                            <div class="self-center">
                                ...
                                <div id="star"
                                    ...
                                    <ul class="py-2 p-4 text-sm text-gray-700 "
