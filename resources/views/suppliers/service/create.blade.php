        ...
        <ul data-te-stepper-init
            ...
            <li data-te-stepper-step-ref data-te-stepper-step-active class="w-[4.5rem] flex-auto">
                ...
                <div data-te-stepper-content-ref class="absolute w-full p-16 transition-all duration-500 ease-in-out">
                    ...
                    <div>
                        ...
                        <p class="pb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Aenean quis
                            mattis
                            ex, in tristique libero. Integer urna ante, dapibus ac maximus vel,
                            cursus quis sem.
                            Proin
                            turpis arcu, vehicula non tortor ut, sodales luctus erat. Maecenas
                            ligula libero,
                            feugiat
                            eget malesuada id, imperdiet sagittis tellus. Maecenas consectetur eget
                            nisl laoreet
                            sollicitudin. Donec hendrerit mi et risus consectetur dapibus. Sed
                            congue, ex id viverra
                            mattis, augue eros condimentum orci, a volutpat augue leo a massa.
                            Praesent pulvinar
                            urna
                            lorem, vel vulputate velit laoreet mollis. Quisque venenatis consectetur
                            leo efficitur
                            tempor. Aliquam congue mi posuere, pharetra odio eget, posuere enim.
                            Vivamus cursus sem
                            at
                            imperdiet ornare. Aliquam ac enim massa. Sed et semper massa, sit amet
                            consequat lectus.
                        </p>
                        <hr class="pb-8">
                    </div>
            ...
            <li data-te-stepper-step-ref class="w-[4.5rem] flex-auto">
                ...
                <div data-te-stepper-content-ref
                    ...
                    <div>
                        ...
                        <p class="pb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Aenean quis
                            mattis ex, in tristique libero. Integer urna ante, dapibus ac maximus
                            vel, cursus quis
                            sem. Proin turpis arcu, vehicula non tortor ut, sodales luctus erat.
                            Maecenas ligula
                            libero, feugiat eget malesuada id, imperdiet sagittis tellus. Maecenas
                            consectetur eget
                            nisl laoreet sollicitudin. Donec hendrerit mi et risus consectetur
                            dapibus. Sed congue,
                            ex id viverra mattis, augue eros condimentum orci, a volutpat augue leo
                            a massa.
                            Praesent pulvinar urna lorem, vel vulputate velit laoreet mollis.
                            Quisque venenatis
                            consectetur leo efficitur tempor. Aliquam congue mi posuere, pharetra
                            odio eget, posuere
                            enim. Vivamus cursus sem at imperdiet ornare. Aliquam ac enim massa. Sed
                            et semper
                    ...
                    <div class="p-5">
                        <div class="mx-auto grid grid-cols-3 gap-4">
                            ...
                            <button type="button"
                                ...
                                @click="addPackage()" x-show="packages.length < 3">Add
                                Package</button>
            ...
            <li data-te-stepper-step-ref class="w-[4.5rem] flex-auto">
                ...
                <div data-te-stepper-content-ref
                    ...
                    <p class="pb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Aenean quis mattis
                        ex, in tristique libero. Integer urna ante, dapibus ac maximus vel, cursus
                        quis sem. Proin
                        turpis arcu, vehicula non tortor ut, sodales luctus erat. Maecenas ligula
                        libero, feugiat
                        eget malesuada id, imperdiet sagittis tellus. Maecenas consectetur eget nisl
                        laoreet
                        sollicitudin. Donec hendrerit mi et risus consectetur dapibus. Sed congue,
                        ex id viverra
                        mattis, augue eros condimentum orci, a volutpat augue leo a massa. Praesent
                        pulvinar urna
                        lorem, vel vulputate velit laoreet mollis. Quisque venenatis consectetur leo
                        efficitur
                        tempor. Aliquam congue mi posuere, pharetra odio eget, posuere enim. Vivamus
                        cursus sem at
                        imperdiet ornare. Aliquam ac enim massa. Sed et semper massa, sit amet
                        consequat lectus.
                    </p>
                    ...
                    <div class="grid grid-cols-2 gap-16 text-left">
                        ...
                        <div>
                            <textarea x-model="title" :maxLength="titleLimit"
                                class="form-control focus:outline-non m-0 block h-20 w-full resize rounded border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-1.5 text-base font-normal text-gray-700 shadow-inner transition ease-in-out focus:border-gray-600 focus:bg-white focus:text-gray-700"
                                id="exampleFormControlTextarea1" placeholder="Create a title, maximum of 100 letters" require=""></textarea>
                            <div class="text-right" x-text="title.length + `/` + titleLimit">
                            </div>
                        </div>
                        <div class="text-lg font-bold uppercase text-gray-600">Category
                        </div>
