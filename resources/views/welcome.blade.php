    ...
    <section class="bg-white" data-aos="zoom-in" data-aos-duration="1500">
        <div class="mx-auto grid max-w-screen-xl px-4 xs:grid xs:place-content-center lg:grid-cols-12 lg:gap-8 xl:gap-0">
            ...
            <div class="mr-auto place-self-center xs:col-span-12 sm:p-8 lg:col-span-7 lg:p-0">
                <h1
                    class="mb-4 max-w-2xl text-center font-extrabold leading-none tracking-wide xs:text-4xl sm:text-justify sm:text-6xl lg:text-7xl">
                    <span class="text-[#7895b2]"> Whatever you’re <br>
                        planning,</span> <span class="tracking-wide text-black sm:text-5xl lg:text-6xl"> make it <br>
                        extraordinary</span>
                </h1>
                <p
                    class="mb-6 max-w-2xl text-center font-light tracking-wide text-black xs:text-lg md:text-lg lg:mb-8 lg:text-xl">
        ...
        <div class="px-4 py-9 2xl:container md:px-20 md:py-12 2xl:mx-auto">
            <div class="relative rounded-md bg-gradient-to-r from-[#AEBDCA] to-[#F5EFE6]">
                ...
                <div
                    ...
                    <div>
                        <h1 class="w-64 text-3xl font-bold leading-9 text-black sm:w-auto md:text-5xl md:leading-10">
                            Come and Join us!</h1>
