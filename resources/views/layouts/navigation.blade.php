...
<!-- Mobile Header & Nav -->
<header x-data="{ isOpen: false }" class="w-full bg-blue-500 py-5 px-6 sm:hidden">
    ...
    <div :class="isOpen ? 'flex' : 'hidden'">
        ...
        <x-page-links class="flex flex-col space-y-4 pt-4">
            <a href="#" class="flex items-center text-white opacity-75 hover:opacity-100 pl-6 nav-item">
