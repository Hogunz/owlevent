            ...
            <ul
                ...
                <li>
                    @if (!auth()->user())
                        <!--LOGIN WITH MODAL -->
                        <button type="button"
                            class="border rounded-lg px-8 py-2 text-white bg-[#7895B2] hover:bg-[#7895B2]/75"
                                ...
                                {{-- <div
                                    ...
                                    <form class="space-y-6" method="POST" action="{{ route('login') }}">
                                        ...
                                        <a class="px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded-full shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center"
                                            style="background-color: #55acee" href="/auth/google" role="button"
                                            data-mdb-ripple="true" data-mdb-ripple-color="light">
                                            <!-- Twitter -->
...
<div id="drawer-navigation"
    ...
    <div class="py-4 overflow-y-auto">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/featured" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 ">
                    <svg aria-hidden="true"
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 ">
                    ...
                    @if (!auth()->user())
                        <span class="lg:flex-1 sm:hidden ml-3 whitespace-nowrap" data-modal-target="medium-modal"
                            data-modal-toggle="medium-modal">Sign In</span>
                    @else
                        <!-- Settings Dropdown -->
