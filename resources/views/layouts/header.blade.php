            ...
            <ul
                ...
                <li>
                    ...
                    <div id="medium-modal" tabindex="-1" aria-hidden="true"
                        class="fixed top-0 right-0 left-0 z-50 hidden h-modal w-full items-center justify-center overflow-y-auto overflow-x-hidden sm:inset-0 sm:max-h-full">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <a href="#" class="flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100">
                    ...
                    @if (!auth()->user())
                        <span class="ml-3 whitespace-nowrap sm:hidden lg:flex-1" data-modal-target="medium-modal"
