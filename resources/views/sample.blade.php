<x-guest-layout>
        ...
        <div class="mx-auto grid max-w-screen-xl px-4 xs:grid xs:place-content-center lg:grid-cols-12 lg:gap-8 xl:gap-0">
            <div class="flex-col xs:col-span-12 sm:flex md:flex-row lg:col-span-5 lg:mt-0">
                <div id="carouselSlide" class="relative sm:hidden lg:flex" data-te-carousel-init data-te-carousel-slide>
                    <div
                        class="block relative overflow-hidden sm:pt-24 pt-8 after:clear-both after:block after:content-['']">
    ...
    <div class="sm:static lg:relative " data-aos="fade-up" data-aos-duration="1500">
        ...
        <section class=" ">
            <div class="relative bg-gray-600  w-full" style="height:75vh;">
                <div class="absolute bottom-0 right-0">
                    <img class="lg:max-w-6xl sm:max-w-lg lg:w-full" src="images/try2.png" alt=""
        ...
        <section class="grid grid-cols-4 gap-4 p-8 container mx-auto">
            ...
            <div class="-translate-y-6">
                <img class="rounded-3xl"
                    src="https://images.unsplash.com/photo-1682547094491-f11620a69e3c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                    alt="">
        ...
        <section class="p-8 flex justify-center items-center h-screen ">
            <div class="relative">
                <div
                    class="max-w-lg w-96 h-96 border-2 p-8 rounded-lg rotate-12 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                </div>

                <div class="">
                    <img class="max-w-lg w-96 h-96 border bg-black object-cover rounded-lg absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20"
                        src="https://images.unsplash.com/photo-1682547094491-f11620a69e3c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                        alt="">
                </div>
            </div>
        ...
        <section class="p-8 flex justify-center items-center h-screen">
            <div class="relative">
                ...
                <img src="images/circle/blue.png"
                    class="max-w-lg  p-8 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10"
                    alt="..." />
                <img src="images/circle/logo_site.png"
                    class="max-w-lg  p-8 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20"
                    alt="..." />
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                        <a href=""
                            ...
                            <div class="relative pb-48 overflow-hidden">
                                <img class="absolute inset-0 h-full w-full object-cover" src="images/try.png"
                                    alt="">
                            </div>
                            <div class="p-4">
                                <span
